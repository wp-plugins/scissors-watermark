...
* Deleted "Custom" option from watermarking function and added checkboxes for each of every custom image size (http://wordpress.org/support/topic/plugin-scissors-and-watermark-watermark-for-custom-sizes?replies=1).
