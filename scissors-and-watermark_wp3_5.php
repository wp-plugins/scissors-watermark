...
add_filter( 'plugin_action_links', 'scissors_plugin_settings_link', 10, 2 );
...
function scissors_media_meta()
{
	...
	else
	{
		...
		$string .= " <button class='button' onclick=\"return scissorsWatermark($postId, '$wstate')\">$text_reset</button>";
...
function add_scissors_metabox($post) {
    add_meta_box('scissors_metabox', 'Scissors and Watermark', 'scissors_media_meta', 'attachment', 'advanced', 'default');
}


//add_action( 'media_meta', 'scissors_media_meta', 10, 2 );
